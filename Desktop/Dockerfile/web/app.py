...
def Image_design():
    ...
    f1 = open('/Users/haohui/Desktop/Dockerfile/web/image.txt','w')
    f1.write(text1)
    f1.close()
...
def wordcount():
    ...
    lines = spark.read.text('/Users/haohui/Desktop/Dockerfile/web/image.txt').rdd.map(lambda r: r[0])
    f2 = open('/Users/haohui/Desktop/Dockerfile/web/image.txt')
    print (f2.read())
...
def translation():
    ...
    f1 = open('/Users/haohui/Desktop/Dockerfile/web/trans.txt','r')
    content1 = f1.read()
